const canvasContainer = document.querySelector('.entertainment');
const canvasContainerParams = canvasContainer.getBoundingClientRect();
...
const getParams = randomParams(window.innerWidth, canvasContainerParams.height, 10, -20, 80);

function setup() {
    let myCanvas = createCanvas(window.innerWidth, canvasContainerParams.height);
